...
class CarState(CarStateBase):
  ...
  def update_mqb(self, pt_cp, cam_cp, acc_cp, trans_type):
    ...
    if bool(pt_cp.vl["ESP_21"]['ESP_Haltebestaetigung']) and ret.vEgoRaw < 0.001:
       ret.standstill = bool(True)
     else:
       ret.standstill = bool(False)
  ...
  def get_mqb_can_parser(CP):
    ...
    signals = [
      ...
      ("ESP_Tastung_passiv", "ESP_21", 0),          # Stability control disable
      ("ESP_Haltebestaetigung", "ESP_21", 0),       # prevents set point creepd
